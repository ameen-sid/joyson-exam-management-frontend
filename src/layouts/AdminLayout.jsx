...
import { Activity, LogOut, Users, FolderTree, FileQuestion, BarChart3, Menu, X } from 'lucide-react';
...
export default function AdminLayout() {
    ...
    const navItems = [
        ...
        { to: '/admin/exams', icon: FileQuestion, label: 'Exams' },
                ...
                <div className="relative z-10 shrink-0" ref={userMenuRef}>
                    ...
                    >
                        <div className="text-sm text-right hidden sm:block">
                            ...
                            <div className="text-slate-400 text-xs text-right opacity-80 capitalize">{user.role || 'Admin'}</div>
                        </div>

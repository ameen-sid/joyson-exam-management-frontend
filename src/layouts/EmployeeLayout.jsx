...
import { Activity, LogOut, FileEdit, BarChart3, Menu, X } from 'lucide-react';
...
export default function EmployeeLayout() {
  ...
  const navItems = [
    { to: '/employee/exams', icon: FileEdit, label: 'Exams' },
    { to: '/employee/results', icon: BarChart3, label: 'My Results' }
  ];
    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans flex flex-col relative">
      <header className="sticky top-0 h-20 bg-slate-900 shadow-xl z-50 px-4 md:px-8 flex items-center justify-between shrink-0">
        ...
        <div className="flex items-center space-x-3 md:space-x-4 z-10 shrink-0">
          ...
          <div className="flex items-center justify-center h-9 w-9 md:h-10 md:w-10 bg-blue-600 rounded-xl text-white shadow-lg shadow-blue-900/50 block">
        ...
        <div className="relative z-10 shrink-0" ref={userMenuRef}>
          ...
          >
            <div className="text-sm text-right hidden sm:block">
              ...
              <div className="text-slate-400 text-xs text-right opacity-80 capitalize">{user.role || 'Employee'}</div>
            </div>
            <div className="h-9 w-9 md:h-10 md:w-10 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center text-white font-bold shadow-lg border-2 border-slate-800 shrink-0">
